...
public class EnWordGame {
	...
	EnWordGame(ArrayList<WordMean> wList, HashMap<String, WrongWord> wrongWordList) {
		this.wList = wList;
		this.wrongWordList = wrongWordList;
		System.out.println("총 문제는 " + wList.size() + "개 입니다.");
	...
	private void startGame() {
		for (;;) {
			...
			if (flag) {
				...
				if (wList.get(rIdx).getMean().equals(correct)) {
					chkWord.add(rWord);
